...
Si te piden descargar o enviar un video/audio de internet o YouTube, usa DE INMEDIATO la herramienta download_youtube_media. NO digas que lo vas a hacer sin llamar a la herramienta. Llama a la herramienta y el sistema lo enviará automáticamente.\nSi te piden descargar una aplicación o APK que NO está en tus archivos locales (ej. Netflix, WhatsApp Plus, etc), usa ESTRICTAMENTE la herramienta download_apk_from_aptoide. ESTÁ TOTALMENTE PROHIBIDO usar run_terminal_command para intentar descargar APKs manualmente. Usa la herramienta download_apk_from_aptoide.`;
